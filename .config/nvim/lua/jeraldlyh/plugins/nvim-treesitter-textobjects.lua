return {
  ...
  config = function()
    ...
    vim.keymap.set({ "n", "x", "o" }, ";", tsRepeatMove.repeat_last_move)
    vim.keymap.set({ "n", "x", "o" }, ",", tsRepeatMove.repeat_last_move_opposite)

    vim.keymap.set({ "n", "x", "o" }, "f", tsRepeatMove.builtin_f)
    vim.keymap.set({ "n", "x", "o" }, "F", tsRepeatMove.builtin_F)
